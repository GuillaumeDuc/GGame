...
public class CreatePlanetTemperate : CreatePlanet
{
    public CreatePlanetTemperate(int resolution, float radius, Material planetMaterial, Material cloudMaterial)
    {
    ...
    protected override void SetBiomes(ColorSettings colorSettings)
    {
        ...
        biomes[2] = PlanetCreationHelper.GetDesertBiome(0.35f);
        biomes[3] = PlanetCreationHelper.GetTropicalBiome(0.75f);
